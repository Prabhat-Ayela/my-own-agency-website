...
const About = () => {
    return (
        ...
        <div className='bg-[url(/src/assets/funfact_bg.svg)] bg-no-repeat bg-center h-full w-full absolute top-0 left-0 opacity-75'id = "about"></div>
        {/* let side text*/}
        <div>
            <h2 className='text-5xl font-bold mb-5'>Our fun fact</h2>
            <p className='text-gray-300'>Sed ut perspiciatis unde omnis iste natus error voluptatem accusanti doloremque laudantium, totam rem aperiam, eaque ipsa quae ab illo inventore veritatis.</p>
        </div>
        {/* right side text */}
