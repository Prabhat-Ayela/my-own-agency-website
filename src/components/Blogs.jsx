...
const Blogs = () => {
    return(
        <div className=' text-white lg:px-24 px-4'>
            {/* blog top */}
            <div>
                <h2 className='text-4xl font-bold text-center leading-snug lg:w-4/6 mx-auto pb-20'>Our agile process is ability to adapt and respond to change. Agile organizations view change as an oppurtunity, not a threat </h2>
           ...
           <div className= "relative " id ="blogs">
            <div className= "flex flex-col lg:flex-row justify-between lg:item-center gap-12 z-30 ">
           {/* content */}
           ...
           <div className="lg:w-2/3 my-8">
             ...
             <div className="h-8 w-1/2 rounded-e-2xl rounded-e-2xl bg-orange"></div>
             </div>
             {/* blog cards */}
             <BlogCard/>
             {/* btn */}
             <div>
                 <buttton className="lg:absolute right-0 mt-8 px-6 py-2 bg-white text-black rounded hover:bg-orange hover:text-white transition-all duration-300 hover:-translate-y-3">Read More</buttton>
             </div>
           </div>
            </div>
             {/* shapes */}
